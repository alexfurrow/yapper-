        ...
        response = client.chat.completions.create(
            ...
            messages=[
                {"role": "system", "content": """You are an expert as parsing people's natural thoughts into an organized set of ideas. if possible, order them in sequence from earlier to later. Your response must be in JSON format. 
                 For instance:
                 User input:
                    today i woke up and i had slept well but i didn't quite still feel energized. i was still feeling a little defeated from yesterday and i thought that maybe i should just take it easy to start. i had a few coffees, which was great, and i played some games of dota. 
                    ...
                    moreover, i had a chat with myself, and i am still committed to not ordering doordash as at all, and i recognized in my talk with myself that i was basically improving - last year i ended the year ordering it multiple times per week, maybe as many as 8 times a month, and this month i only ordered it 3 times. 
                 ...
                 Output: 
                    Parsed entry: 'In the morning, the user woke up. They did not feel energetic, and they were feeling defeated. They decided to take it easy with a few coffees and games of DOTA. They played well the first game, but their teammates carried the user to victory, meaning they were not playing as well as their teammates and they needed support of the other users.'
